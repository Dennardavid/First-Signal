    ...
    <section className="flex justify-center gap-20 text-center border-b-[1px] border-b-[#D9D9D9] pb-20">
      <div className="w-[500px] bg-[#D9D9D9] p-8 rounded-lg shadow-lg">
        ...
        <p>
          ...
          businesses to achieve their goals through innovation, efficiency, and
          reliability. We aim to be a trusted partner in the digital
          transformation journey of our clients, offering tailored services that
      ...
      <div className="w-[500px] bg-[#D9D9D9] p-8 rounded-lg shadow-lg">
        ...
        <p>
          ...
          service delibvery , technological expertise, and customer satisfaction
          in Nigeria and beyound
        </p>
      </div>
    </section>
  );
