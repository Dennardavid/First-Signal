export default function Missions() {
  return (
    <section className="border-b-[1px] border-b-[#D9D9D9] px-5 pb-5 xl:pb-20">
      <div className="w-full max-w-7xl mx-auto flex flex-col xl:flex-row justify-center gap-6 xl:gap-8 text-center">
        <div className="w-[350px] xl:w-[590px] bg-[#D9D9D9] p-3 xl:p-8 rounded-lg shadow-lg">
        ...
        <div className="w-[350px] xl:w-[590px] bg-[#D9D9D9] p-3 xl:p-8 rounded-lg shadow-lg">
          ...
          <p className="text-sm xl:text-lg">
            ...
            service delibvery , technological expertise, and customer
