export default function Hero() {
  return (
    <section className="flex flex-col items-center text-center mt-5 xl:mt-10">
      <h1 className="text-2xl w-[80%] lg:w-[60%] md:text-5xl xl:text-7xl font-bold xl:w-[850px] md:leading-tight xl:leading-snug">
      ...
      <div className="bg-[#0F1E5A] text-white pt-5 pb-5 xl:pt-10 xl:pb-10 -mt-16 xl:-mt-48 w-[100%] flex items-center flex-col">
        ...
        <p className="text-sm w-[90%] md:w-[80%] md:text-base xl:w-[750px] mt-4 xl:mt-5 xl:leading-7 xl:text-lg">
