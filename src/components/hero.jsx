export default function Hero() {
  return (
    <section className="flex flex-col items-center text-center mt-3 lg:mt-5 xl:mt-10">
      <h1 className="text-[#0A1540] text-2xl w-[80%] lg:w-[60%] md:text-5xl xl:text-7xl font-bold xl:w-[850px] md:leading-tight xl:leading-snug">
