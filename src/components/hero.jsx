export default function Hero() {
  return (
    <section className="flex flex-col items-center text-center mt-10">
      ...
      <p className="text-lg w-[700px] mt-4">
      ...
      <div className="bg-[#0F1E5A] text-white pt-20 pb-10 -mt-48 w-[100%] flex items-center flex-col">
        <h2 className="text-6xl font-bold w-[950px] text-[#CCD6EB]">Unleash Your Business potential with smart tech solutions</h2>
        <p className="w-[650px] mt-8 leading-7 text-lg">
