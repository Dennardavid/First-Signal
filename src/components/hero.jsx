export default function Hero() {
  return (
    <section className="flex flex-col items-center text-center mt-5 xl:mt-10">
      <h1 className="text-2xl w-[80%] lg:w-[60%] md:text-5xl xl:text-6xl font-bold xl:w-[750px] md:leading-tight xl:leading-snug">
        We are First Signal Global Services limited
      </h1>
      <p className="text-sm w-[80%] md:w-[82%] lg:w-[75%] md:text-base xl:text-lg xl:w-[750px] mt-4">
      ...
      <img src="/hero.png" alt="Network cables" className="w-[90%] md:w-[80%] lg:w-[60%] mt-5" />
      <div className="bg-[#0F1E5A] text-white pt-5 pb-5 xl:pt-20 xl:pb-10 -mt-16 xl:-mt-48 w-[100%] flex items-center flex-col">
        <h2 className="text-2xl w-[85%] md:w-[70%] md:text-3xl xl:text-6xl font-bold xl:w-[1000px] text-[#CCD6EB]">Unleash Your Business potential with smart tech solutions</h2>
        <p className="text-sm w-[90%] md:w-[80%] md:text-base xl:w-[750px] mt-4 xl:mt-8 xl:leading-7 xl:text-lg">
        ...
        <div className="flex flex-col justify-center gap-5 mt-5 px-5 md:flex-row xl:gap-16 xl:mt-12">
